                                ...
                                return (
                                    <ActivityCard
                                        ...
                                        activity={{
                                            ...
                                            name: item.name,
                                            date: item.startDate,
                                            distance: item.distanceMiles === null ? "N/A" : `${item.distanceMiles} mi`,
                                            time: item.movingTimeMinutes === null ? "N/A" : `${item.movingTimeMinutes} min`,
                                            pace: item.pacePerMile ?? "N/A",
                                            averageWatts: item.averageWatts === null ? "N/A" : String(item.averageWatts),
